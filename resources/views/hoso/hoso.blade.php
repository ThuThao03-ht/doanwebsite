        ...
        <div class="row g-0">
            ...
            <div class="col-md-4 bg-light d-flex flex-column align-items-center py-4 position-relative">
                <div class="position-relative">
                    ...
                    <form method="POST" action="{{ route('admin.hoso.updateAvatar') }}" enctype="multipart/form-data"
...
<div class="modal fade" id="modalCapNhat" tabindex="-1" aria-labelledby="modalCapNhatLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <form method="POST" action="{{ route('admin.hoso.update') }}" class="modal-content rounded-4 border-0 shadow">
            @csrf
